...
public:
    ...
    uintptr_t GetCurrentWeaponActor(uintptr_t actor) {
        ...
        FTArrayRaw EquippedPrimaryItem = Memory::read<FTArrayRaw>(inventoryComponent + Offsets::EquippedPrimaryItem);

        if (!EquippedPrimaryItem.Data || EquippedPrimaryItem.Count <= 0)
            return 0;

        return Memory::read<uintptr_t>(EquippedPrimaryItem.Data);
    }
    ...
    int GetWeaponQuality(uintptr_t actor) {
        ...
        FTArrayRaw itemArray = Memory::read<FTArrayRaw>(inventoryComponent + Offsets::EquippedPrimaryItem);
...
public:
    ...
    private:
        ...
        double ou_sigma = 0.4;      // Drift magnitude (reduzido para n�o atrapalhar)
    ...
    public:
        ...
        // Aplica humaniza��o na rota��o (pitch/yaw em graus)
